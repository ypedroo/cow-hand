...
local function createBaddola()
 ...
 local whereFrom = math.random( 3 )
     ...
     if ( whereFrom == 1 ) then
        newBill.x = display.contentCenterX + 100
...
local whereFrom = math.random( 3 )
    if ( whereFrom == 1 ) then
       goodBill.x = display.contentCenterX + 100
	   goodBill.y = (600)
...
local whereFrom = math.random( 3 )
	if ( whereFrom == 1 ) then
	jackpot.x = display.contentCenterX + 100
	jackpot.y = (600)
...
local whereFrom = math.random( 3 )
    if ( whereFrom == 1 ) then
		gargoyle.x = display.contentCenterX + 100
		gargoyle.y = (100)
...
--function to create golpe
	...
	local whereFrom = math.random( 3 )
		if ( whereFrom == 1 ) then
			golpe.x = display.contentCenterX + 100
			golpe.y = (100)
...
local whereFrom = math.random( 3 )
    if ( whereFrom == 1 ) then
		medkit.x = display.contentCenterX + 100
		medkit.y = (100)
...
function scene:create( event )
	...
	gnd1.x = 0
	gnd1.y = display.contentCenterY +550
	gnd1.cY = 0.7
	...
	gnd2.x = 2350
	gnd2.y = display.contentCenterY +550
	gnd2.cY = 0.7
    ...
    -- City
    local city1 = display.newImageRect("ui/screens/bg1.png", 1850, 800 )
    city1.x = cX/2
	city1.y = h-250
	city1.speed = 1
	...
	nuvem2.x = display.contentCenterX +400
	nuvem2.y = display.contentCenterY +100
	nuvem2.cY = 0.7
    ...
    -- Score
    livesText = display.newText( " Lives ".. lives, 50, 29, "Skranji-Regular.ttf", 60)
    livesText:setFillColor( 255,255,255 )
    moneyText = display.newText( "    Money ".. money, 300, 29, "Skranji-Regular.ttf", 60)
